...
protected:
	...
	void InitializeGui()
	{
		...
		tbxIMEI.CreateX(WS_EX_CLIENTEDGE, NULL, WS_CHILD | WS_TABSTOP | WS_VISIBLE | ES_AUTOHSCROLL | ES_LEFT | ES_WINNORMALCASE, 6.77333, 12.99104, 4.41854, 0.60854, hWnd, 1020);
